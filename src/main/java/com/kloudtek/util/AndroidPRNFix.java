...
/**
 * Created by yannick on 25/10/13.
 */
public class AndroidPRNFix {
    ...
    private static void installLinuxPRNGSecureRandom()
        ...
        if (!LinuxPRNGSecureRandomProvider.class.equals(
            ...
            throw new SecurityException(
                    "SecureRandom.getInstance(\"SHA1PRNG\") backed by wrong Provider: " + rng2.getProvider().getClass());
        }
    }
    ...
    public static class LinuxPRNGSecureRandom extends SecureRandomSpi {
        ...
        protected void engineSetSeed(byte[] bytes) {
            try {
                ...
                // Log and ignore.
                Log.w(AndroidPRNFix.class.getSimpleName(), "Failed to mix seed into " + URANDOM_FILE);
            } finally {
                mSeeded = true;
            }
        }
