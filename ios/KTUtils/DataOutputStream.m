...
- (void)writeStringWithNSString:(NSString *)str {
  [KTUtilsDataOutputStream writeStringWithJavaIoDataOutput:self withNSString:str];
}

- (void)writeDataWithByteArray:(IOSByteArray *)data {
  [KTUtilsDataOutputStream writeDataWithJavaIoDataOutput:self withByteArray:data];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _KTUtilsDataOutputStream = { "DataOutputStream", "com.kloudtek.util.io", NULL, 0x1, 4, methods, 0, NULL, 0, NULL};
