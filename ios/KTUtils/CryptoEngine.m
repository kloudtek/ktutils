...
- (id<JavaxCryptoSecretKey>)generateAes192Key {
  return [self generateKeyWithComKloudtekUtilCryptoSymmetricAlgorithmEnum:ComKloudtekUtilCryptoSymmetricAlgorithmEnum_get_AES() withInt:192];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "generateAes192Key", NULL, "Ljavax.crypto.SecretKey;", 0x1, NULL },
