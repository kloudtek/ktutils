...
- (id<JavaxCryptoSecretKey>)generateAesKeyWithInt:(int)keySize {
  return [self generateKeyWithComKloudtekUtilCryptoSymmetricAlgorithmEnum:[ComKloudtekUtilCryptoSymmetricAlgorithmEnum AES] withInt:keySize];
}

- (id<JavaxCryptoSecretKey>)generateAes128Key {
  return [self generateKeyWithComKloudtekUtilCryptoSymmetricAlgorithmEnum:[ComKloudtekUtilCryptoSymmetricAlgorithmEnum AES] withInt:128];
}

- (id<JavaxCryptoSecretKey>)generateAes256Key {
  return [self generateKeyWithComKloudtekUtilCryptoSymmetricAlgorithmEnum:[ComKloudtekUtilCryptoSymmetricAlgorithmEnum AES] withInt:256];
}
...
- (JavaSecurityKeyPair *)generateRSA2048KeyPair {
  return [self generateKeyPairWithComKloudtekUtilCryptoAsymmetricAlgorithmEnum:[ComKloudtekUtilCryptoAsymmetricAlgorithmEnum RSA] withInt:2048];
}

- (JavaSecurityKeyPair *)generateRSA4096KeyPair {
  return [self generateKeyPairWithComKloudtekUtilCryptoAsymmetricAlgorithmEnum:[ComKloudtekUtilCryptoAsymmetricAlgorithmEnum RSA] withInt:4096];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComKloudtekUtilCryptoCryptoEngine = { "CryptoEngine", "com.kloudtek.util.crypto", NULL, 0x401, 30, methods, 0, NULL, 0, NULL};
