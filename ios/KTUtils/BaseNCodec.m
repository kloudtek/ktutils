...
+ (int)getEOF {
  return KTUtilBaseNCodec_EOF;
}

+ (int)MIME_CHUNK_SIZE {
  return KTUtilBaseNCodec_MIME_CHUNK_SIZE;
}

+ (int)PEM_CHUNK_SIZE {
  return KTUtilBaseNCodec_PEM_CHUNK_SIZE;
}

+ (int)MASK_8BITS {
  return KTUtilBaseNCodec_MASK_8BITS;
}

+ (char)PAD_DEFAULT {
  return KTUtilBaseNCodec_PAD_DEFAULT;
}
...
- (NSString *)encodeToStringWithByteArray:(IOSByteArray *)pArray {
  return [KTUtilStringUtils fromUTF8WithByteArray:[self encodeWithByteArray:pArray]];
}
...
- (IOSByteArray *)decodeWithNSString:(NSString *)pArray {
  return [self decodeWithByteArray:[KTUtilStringUtils toUTF8WithNSString:pArray]];
}
...
- (BOOL)isInAlphabetWithNSString:(NSString *)basen {
  return [self isInAlphabetWithByteArray:[KTUtilStringUtils toUTF8WithNSString:basen] withBoolean:YES];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "hasDataWithKTUtilBaseNCodec_Context:", NULL, "Z", 0x0, NULL },
    { "availableWithKTUtilBaseNCodec_Context:", NULL, "I", 0x0, NULL },
    { "getDefaultBufferSize", NULL, "I", 0x4, NULL },
    { "resizeBufferWithKTUtilBaseNCodec_Context:", NULL, "LIOSByteArray", 0x2, NULL },
    { "ensureBufferSizeWithInt:withKTUtilBaseNCodec_Context:", NULL, "LIOSByteArray", 0x4, NULL },
    { "readResultsWithByteArray:withInt:withInt:withKTUtilBaseNCodec_Context:", NULL, "I", 0x0, NULL },
    ...
    { "encodeWithByteArray:withInt:withInt:withKTUtilBaseNCodec_Context:", NULL, "V", 0x400, NULL },
    { "decodeWithByteArray:withInt:withInt:withKTUtilBaseNCodec_Context:", NULL, "V", 0x400, NULL },
  ...
  static J2ObjcClassInfo _KTUtilBaseNCodec = { "BaseNCodec", "com.kloudtek.util", NULL, 0x401, 21, methods, 12, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _KTUtilBaseNCodec_Context = { "Context", "com.kloudtek.util", "BaseNCodec", 0x8, 1, methods, 8, fields, 0, NULL};
