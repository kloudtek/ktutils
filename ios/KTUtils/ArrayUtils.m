...
+ (IOSByteArray *)toBytesWithCharArray:(IOSCharArray *)chars {
  ...
  return [((JavaNioByteBuffer *) nil_chk([((JavaNioCharsetCharset *) nil_chk(JavaNioCharsetStandardCharsets_get_UTF_8_())) encodeWithJavaNioCharBuffer:charBuffer])) array];
}

+ (IOSCharArray *)toCharsWithByteArray:(IOSByteArray *)data {
  JavaNioByteBuffer *byteBuffer = [JavaNioByteBuffer wrapWithByteArray:data];
  return [((JavaNioCharBuffer *) nil_chk([((JavaNioCharsetCharset *) nil_chk(JavaNioCharsetStandardCharsets_get_UTF_8_())) decodeWithJavaNioByteBuffer:byteBuffer])) array];
}
