...
static JavaUtilLoggingLogger * KTUtilIOUtils_logger_;

+ (JavaUtilLoggingLogger *)logger {
  return KTUtilIOUtils_logger_;
}

+ (int)DEF_BUFF_SIZE {
  return KTUtilIOUtils_DEF_BUFF_SIZE;
}

+ (int)DEF_CHAR_BUFF_SIZE {
  return KTUtilIOUtils_DEF_CHAR_BUFF_SIZE;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "logger_", NULL, 0x1a, "Ljava.util.logging.Logger;" },
    { "DEF_BUFF_SIZE_", NULL, 0x1a, "I" },
    { "DEF_CHAR_BUFF_SIZE_", NULL, 0x1a, "I" },
  };
  static J2ObjcClassInfo _KTUtilIOUtils = { "IOUtils", "com.kloudtek.util.io", NULL, 0x1, 10, methods, 3, fields, 0, NULL};
